                ...
                >
                    <Flex direction={'column'} gap={4}>
                        ...
                        <Text
                            ...
                            color={'monotone.600'}
                        >
                            Ipsum dolor sit amet, consectetur adipiscing elit. Nulla nec purus feugiat. Sed auctor nunc
                            quis mauris malesuada, quis consequat libero sagittis.
                        </Text>
                    </Flex>

                    <PrimaryButton as={Link} href={'/property/create'} w={'50%'} maxW={'300px'}>
                        Become a host
                    </PrimaryButton>
                </Flex>
                <Flex
